...
```{r ping, comment=NA, warning=FALSE, message=FALSE}
sofa_ping()
```
***************
...
```{r almsearch2, comment=NA, warning=FALSE, message=FALSE}
...
```{r lotscalls, comment=NA, warning=FALSE, message=FALSE}
...
```{r systemtime, comment=NA, warning=FALSE, message=FALSE}
...
```{r elastic1, comment=NA, warning=FALSE, message=FALSE}
...
```{r elastic2, comment=NA, warning=FALSE, message=FALSE}
...
```{r viewwrite, comment=NA, warning=FALSE, message=FALSE}
...
```{r viewget, comment=NA, warning=FALSE, message=FALSE}
...
```{r viewsearch, comment=NA, warning=FALSE, message=FALSE}
...
#### Delete the view
```{r viewdelete, comment=NA, warning=FALSE, message=FALSE}

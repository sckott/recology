...
```{r installstuff, comment=NA, warning=FALSE, message=FALSE}
...
```{r kml, comment=NA, warning=FALSE, message=FALSE}
...
```{r shp, comment=NA, warning=FALSE, message=FALSE}

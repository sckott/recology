...
```{r rcharts, eval=FALSE, cache=TRUE}
library(devtools)
...
```{r installpkgs, eval=FALSE, cache=TRUE}
library(devtools)
...
```{r govdat, warning=FALSE, comment=NA, message=FALSE, cache=TRUE}
library(govdat)
library(ggplot2)
...
```{r seaice2, warning=FALSE, comment=NA, message=FALSE, cache=TRUE}
library(rnoaa)
library(scales)
library(ggplot2)
library(doMC)
...
```{r, warning=FALSE, comment=NA, message=FALSE, cache=TRUE}
library(rWBclimate)
...
```{r rnpn, warning=FALSE, comment=NA, message=FALSE, cache=TRUE}
library(rnpn)

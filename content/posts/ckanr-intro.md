...
> Note: the default URL is for https://data.techno-science.ca/. You can change that in the `url` parameter
...
* `url` Base url to use. Default: [https://data.techno-science.ca](https://data.techno-science.ca)
